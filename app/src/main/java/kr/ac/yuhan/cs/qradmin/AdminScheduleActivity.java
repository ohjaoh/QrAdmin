...
import kr.ac.yuhan.cs.qradmin.adapter.TodoListAdapter;
import kr.ac.yuhan.cs.qradmin.data.TodoData;
import kr.ac.yuhan.cs.qradmin.db.DatabaseHelper;
...
public class AdminScheduleActivity extends AppCompatActivity {
    ...
    public static class TodoDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            View view = inflater.inflate(R.layout.dialog_todo_input, null);
